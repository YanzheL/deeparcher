...
_COMPONENTATTR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='components', full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.ComponentAttr.components',
            index=1,
...
_GRAPHELEMENTSATTRMAP_DATAENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key', full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.GraphElementsAttrMap.DataEntry.key',
            index=0,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.GraphElementsAttrMap.DataEntry.value', index=1,
...
_GRAPHELEMENTSATTRMAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='type_url', full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.GraphElementsAttrMap.type_url',
            index=1,
