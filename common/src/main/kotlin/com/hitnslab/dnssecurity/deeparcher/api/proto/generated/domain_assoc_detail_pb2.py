...
_DOMAINASSOCDETAIL = _descriptor.Descriptor(
  ...
  full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.DomainAssocDetail',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='fqdn', full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.DomainAssocDetail.fqdn', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='domain', full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.DomainAssocDetail.domain', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cnames', full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.DomainAssocDetail.cnames', index=4,
...
DESCRIPTOR.message_types_by_name['DomainAssocDetail'] = _DOMAINASSOCDETAIL
