...
#ifndef GOOGLE_PROTOBUF_INCLUDED_com_2fhitnslab_2fdnssecurity_2fdeeparcher_2fapi_2fproto_2fgraph_5fedge_5fupdate_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_com_2fhitnslab_2fdnssecurity_2fdeeparcher_2fapi_2fproto_2fgraph_5fedge_5fupdate_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_com_2fhitnslab_2fdnssecurity_2fdeeparcher_2fapi_2fproto_2fgraph_5fedge_5fupdate_2eproto
...
struct TableStruct_com_2fhitnslab_2fdnssecurity_2fdeeparcher_2fapi_2fproto_2fgraph_5fedge_5fupdate_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_com_2fhitnslab_2fdnssecurity_2fdeeparcher_2fapi_2fproto_2fgraph_5fedge_5fupdate_2eproto;
namespace com {
namespace hitnslab {
...
class GraphAssocEdgeUpdate :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_com_2fhitnslab_2fdnssecurity_2fdeeparcher_2fapi_2fproto_2fgraph_5fedge_5fupdate_2eproto);
    return ::descriptor_table_com_2fhitnslab_2fdnssecurity_2fdeeparcher_2fapi_2fproto_2fgraph_5fedge_5fupdate_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  "    future release.")
  std::string* unsafe_arena_release_fqdn1();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_fqdn1(
      std::string* fqdn1);
  private:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_fqdn2();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_fqdn2(
      std::string* fqdn2);
  private:
 ...
 private:
  ...
  friend struct ::TableStruct_com_2fhitnslab_2fdnssecurity_2fdeeparcher_2fapi_2fproto_2fgraph_5fedge_5fupdate_2eproto;
};
// ===================================================================
...
inline void GraphAssocEdgeUpdate::_internal_set_fqdn1(const std::string& value) {
  ...
  fqdn1_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
}
...
inline std::string* GraphAssocEdgeUpdate::_internal_mutable_fqdn1() {
  ...
  return fqdn1_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline std::string* GraphAssocEdgeUpdate::release_fqdn1() {
  ...
  return fqdn1_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
...
inline std::string* GraphAssocEdgeUpdate::unsafe_arena_release_fqdn1() {
  // @@protoc_insertion_point(field_unsafe_arena_release:com.hitnslab.dnssecurity.deeparcher.api.proto.GraphAssocEdgeUpdate.fqdn1)
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  
  return fqdn1_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void GraphAssocEdgeUpdate::unsafe_arena_set_allocated_fqdn1(
    std::string* fqdn1) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  if (fqdn1 != nullptr) {
  ...
  fqdn1_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      fqdn1, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:com.hitnslab.dnssecurity.deeparcher.api.proto.GraphAssocEdgeUpdate.fqdn1)
}
...
inline void GraphAssocEdgeUpdate::_internal_set_fqdn2(const std::string& value) {
  ...
  fqdn2_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
}
...
inline std::string* GraphAssocEdgeUpdate::_internal_mutable_fqdn2() {
  ...
  return fqdn2_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline std::string* GraphAssocEdgeUpdate::release_fqdn2() {
  ...
  return fqdn2_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
...
inline std::string* GraphAssocEdgeUpdate::unsafe_arena_release_fqdn2() {
  // @@protoc_insertion_point(field_unsafe_arena_release:com.hitnslab.dnssecurity.deeparcher.api.proto.GraphAssocEdgeUpdate.fqdn2)
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  
  return fqdn2_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void GraphAssocEdgeUpdate::unsafe_arena_set_allocated_fqdn2(
    std::string* fqdn2) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  if (fqdn2 != nullptr) {
  ...
  fqdn2_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      fqdn2, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:com.hitnslab.dnssecurity.deeparcher.api.proto.GraphAssocEdgeUpdate.fqdn2)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_com_2fhitnslab_2fdnssecurity_2fdeeparcher_2fapi_2fproto_2fgraph_5fedge_5fupdate_2eproto
