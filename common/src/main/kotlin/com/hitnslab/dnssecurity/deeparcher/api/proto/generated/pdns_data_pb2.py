...
_PDNSDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='r_ipv4_addrs', full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.PDnsData.r_ipv4_addrs', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='r_ipv6_addrs', full_name='com.hitnslab.dnssecurity.deeparcher.api.proto.PDnsData.r_ipv6_addrs', index=7,
