...
inline bool KnownMaliciousDomain_Status_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, KnownMaliciousDomain_Status* value) {
...
class KnownMaliciousDomain PROTOBUF_FINAL :
 ...
 public:
  inline KnownMaliciousDomain() : KnownMaliciousDomain(nullptr) {};
...
// string domain = 5;
inline void KnownMaliciousDomain::clear_domain() {
  domain_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& KnownMaliciousDomain::domain() const {
  // @@protoc_insertion_point(field_get:com.hitnslab.dnssecurity.deeparcher.api.proto.KnownMaliciousDomain.domain)
  return _internal_domain();
}
inline void KnownMaliciousDomain::set_domain(const std::string& value) {
  _internal_set_domain(value);
  // @@protoc_insertion_point(field_set:com.hitnslab.dnssecurity.deeparcher.api.proto.KnownMaliciousDomain.domain)
}
inline std::string* KnownMaliciousDomain::mutable_domain() {
  // @@protoc_insertion_point(field_mutable:com.hitnslab.dnssecurity.deeparcher.api.proto.KnownMaliciousDomain.domain)
  return _internal_mutable_domain();
}
inline const std::string& KnownMaliciousDomain::_internal_domain() const {
  return domain_.Get();
}
inline void KnownMaliciousDomain::_internal_set_domain(const std::string& value) {
  
  domain_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void KnownMaliciousDomain::set_domain(std::string&& value) {
  
  domain_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:com.hitnslab.dnssecurity.deeparcher.api.proto.KnownMaliciousDomain.domain)
}
inline void KnownMaliciousDomain::set_domain(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  domain_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:com.hitnslab.dnssecurity.deeparcher.api.proto.KnownMaliciousDomain.domain)
}
inline void KnownMaliciousDomain::set_domain(const char* value,
    size_t size) {
  ...
  domain_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:com.hitnslab.dnssecurity.deeparcher.api.proto.KnownMaliciousDomain.domain)
}
inline std::string* KnownMaliciousDomain::_internal_mutable_domain() {
  
  return domain_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* KnownMaliciousDomain::release_domain() {
  // @@protoc_insertion_point(field_release:com.hitnslab.dnssecurity.deeparcher.api.proto.KnownMaliciousDomain.domain)
  return domain_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void KnownMaliciousDomain::set_allocated_domain(std::string* domain) {
  if (domain != nullptr) {
  ...
  domain_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), domain,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:com.hitnslab.dnssecurity.deeparcher.api.proto.KnownMaliciousDomain.domain)
}
...
inline void KnownMaliciousDomain::_internal_set_service_title(const std::string& value) {
  ...
  service_title_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline std::string* KnownMaliciousDomain::_internal_mutable_service_title() {
  ...
  return service_title_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* KnownMaliciousDomain::release_service_title() {
  ...
  return service_title_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void KnownMaliciousDomain::_internal_set_registrar(const std::string& value) {
  ...
  registrar_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline std::string* KnownMaliciousDomain::_internal_mutable_registrar() {
  ...
  return registrar_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* KnownMaliciousDomain::release_registrar() {
  ...
  return registrar_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
